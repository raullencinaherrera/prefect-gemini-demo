...
def pull_nonexistent_url():
    ...
    # Create an unverified SSL context to bypass the certificate verification failure.
    # This allows the connection to proceed and the intended 404 error to be raised.
